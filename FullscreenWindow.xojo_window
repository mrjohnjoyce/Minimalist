...
#tag WindowCode
	#tag Event
		Sub Activate()
		  HTMLViewer1.Left = (Width/2)-(setwidth/2)
		  HTMLViewer1.Width = setwidth
		  HTMLViewer1.Top = 22
		  HTMLViewer1.Height = Screen(0).AvailableHeight - 20
		  ProgressBar1.left = HTMLViewer1.Left
		  ProgressBar1.Width = HTMLViewer1.Width
		  ProgressBar1.Top = HTMLViewer1.Height + 22
		  ...
		  for i = 0 to UBound(app.HotMarks)
		    ...
		    hm(i).fullWindow = self
		    hm(i).windowSwitch = "full"
